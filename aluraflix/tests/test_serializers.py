...
class ProgramaSerializerTestCase(TestCase):
  ...
  def test_verifica_campos_serializados(self):
    """Garante que o modelo de Programa foi serializado corretamente"""
    data = self.serializer.data
    self.assertEqual(set(data.keys()), set(['titulo', 'tipo', 'data_lancamento', 'likes']))

  
  def test_verifica_conteudo_do_modelo_serializado(self):
    """Garante que o modelo serializado esteja com os dados corretos"""
